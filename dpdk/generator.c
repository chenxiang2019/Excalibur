...
//����ipv4_len next_type udp_len
void count_len(){
	int i=0;
	//�����ֽ�    
	//ipv4 ͷ����С=20�ֽ�  ���60�ֽ�  ��ʱʹ��20 
	//udp ͷ��=8�ֽ�  
	int ipv4_headlen = 20;
	int nexttype_len=0;
	int udp_headlen = 8;
...
int main()
{
	FILE *fpr =fopen("ddos.txt","r");
	FILE *target =fopen("ddos.txt","wb");
	if(fpr==NULL)
		printf("error file");
	char ch;
	while(1){
